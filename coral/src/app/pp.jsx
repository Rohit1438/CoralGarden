...
const bannerImages = [
  "https://img3.wallspic.com/previews/1/8/7/1/21781/21781-thailand-water_resources-boat-vacation-water-x750.jpg",
  "https://w0.peakpx.com/wallpaper/237/59/HD-wallpaper-autumn-in-japan-red-mountain-japan-autumn-japanese-nature-scenery-fuji-fall.jpg",
];
  ...
  return (
    ...
    <div className="image-container z-0 ">
      <Image
        ...
        layout="fill"
        objectFit="cover"
        className={`transition-opacity relative duration-300 ${
          transitioning ? "opacity-40 animate-zoom-in" : "opacity-100 "
        } animate-zoom-in`}
      />

      <div className="absolute flex flex-col text-purple-800 z-50 to-[30vh] md:top-[50vh]font-white inset-0 flex items-center justify-center">
        <h1
          className="text-4xl md:text-8xl lg:text-8xl xl:text-12xl px-6 py-8 mb-12 text-white text-center drop-shadow-2xl"
          style={{
